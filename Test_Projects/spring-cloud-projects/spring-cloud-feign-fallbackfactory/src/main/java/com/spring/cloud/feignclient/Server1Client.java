...
import com.spring.cloud.fallbackfactory.HystrixClientFallbackFactory;
 ...
 */
@FeignClient(name = "server-1", configuration = FeignConfig.class, /*fallback = Server1HystrixFallbacks.class, */fallbackFactory = HystrixClientFallbackFactory.class)
